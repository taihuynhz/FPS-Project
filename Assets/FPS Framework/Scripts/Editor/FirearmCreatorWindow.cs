    ...
    public class FirearmCreatorWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Create", GUILayout.MaxWidth(100)))
            {
                ...
                newFirearm.gameObject.AddComponent<FirearmInputManager>();
                Close();
            }
        }
        ...
        private FirearmData CreateFirearmFromPreset()
        {
            ...
            switch (usedPreset)
            {
                ...
                case FirearmPreset.AssaultRifle:
                    ...
                    data.reloadOnAwake = false;

                    data.reloadType = Weapon.ReloadType.Automatic;
                    ...
                    data.RecoilKickBack = new Vector3(0.01f, 0.01f, -0.3f);
                    data.RecoilRotation = new Vector3(-10, 15, 25);
                    data.RecoilKickBack_Aim = new Vector3(-0.01f, 0.01f, -0.16f);
                    data.RecoilRotation_Aim = new Vector3(-2, 3, 3);
                ...
                case FirearmPreset.Sniper:
                    ...
                    data.RecoilKickBack = new Vector3(0.01f, 0.01f, -0.7f);
                    data.RecoilRotation = new Vector3(-15, 25, 15);
                    data.RecoilKickBack_Aim = new Vector3(-0.01f, 0.01f, -0.7f);
                    data.RecoilRotation_Aim = new Vector3(-2, 3, 3);
                    break;
                #endregion
                ...
                case FirearmPreset.Shotgun:
                    ...
                    data.reloadType = Weapon.ReloadType.Manual;
                    data.reloadTime = 0.583f;
                    data.emptyReloadTime = 0;
                    data.flexibleReloadTime = true;
                    ...
                    data.RecoilKickBack = new Vector3(0.01f, 0.1f, -1f);
                    data.RecoilRotation = new Vector3(-15, 25, 15);
                    data.RecoilKickBack_Aim = new Vector3(-0.01f, 0.01f, -0.5f);
                    data.RecoilRotation_Aim = new Vector3(-2, 3, 3);
                    break;
                #endregion
                ...
                case FirearmPreset.Pistol:
                    ...
                    data.RecoilKickBack = new Vector3(0.01f, 0.01f, -0.5f);
                    data.RecoilRotation = new Vector3(-10, 15, 25);
                    data.RecoilKickBack_Aim = new Vector3(-0.01f, 0.01f, -0.4f);
                    data.RecoilRotation_Aim = new Vector3(-20, 10, 25);
        ...
        {
            replacement = EditorGUILayout.ObjectField(new GUIContent("Replacement", "The pickuable item which is going to be thrown when replacing weapon with another or throwing it."), replacement, typeof(Pickupable), true) as Pickupable;
        ...
        private void UpdateFire()
        {
            ...
            if (projectile)
            {
                ...
                if (reloadType == Weapon.ReloadType.Manual)
                {
                ...
                if (reloadType == Weapon.ReloadType.Automatic)
                {
